...
export default function CVPage() {
  ...
  const education = [
    {
      university: 'دانشگاه فنی استانبول (ITU)',
      degree: 'لیسانس علوم کامپیوتر',
      duration: '۲۰۱۸ - ۲۰۲۲',
      details: 'تمرکز بر مهندسی نرم‌افزار و سیستم‌های هوشمند در یکی از برترین دانشگاه‌های فنی جهان.'
    },
    {
      university: 'دوره‌های مدیریت کسب و کار',
      degree: 'تخصص در دیجیتال مارکتینگ و تجارت الکترونیک',
      duration: '۲۰۱۶ - ۲۰۲۳',
      details: 'گذراندن دوره‌های تخصصی مدیریت کسب و کار با تمرکز بر استراتژی‌های تجارت الکترونیک و کارآفرینی.'
    }
  ];
  ...
  const experience = [
    {
      role: 'متخصص IT',
      company: 'فدراسیون فوتبال افغانستان',
      duration: '۱.۵ سال',
    ...
    },
    {
      ...
      duration: '۳ سال',
      description: 'تدریس علوم کامپیوتر و دروس تخصصی فناوری اطلاعات.'
    }
  ];

  const skills = [
    { 
      category: 'طراحی خلاقانه و سه‌بعدی', 
      items: [
    ...
    { 
      category: 'تجارت الکترونیک و کسب‌وکار', 
      items: [
  ...
  const socials = [
    { name: 'لینکدین', url: 'https://www.linkedin.com/in/shaheen-safi-b73a30299', icon: <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6zM2 9h4v12H2z" /> },
    { name: 'اینستاگرام', url: 'https://www.instagram.com/top_g_official1', icon: <><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></> },
    { name: 'تیک‌تاک', url: 'https://www.tiktok.com/@safi_sahib6', icon: <path d="M9 12a4 4 0 1 0 4 4V4a5 5 0 0 0 5 5v3a3 3 0 0 1-3-3v7a8 8 0 1 1-8-8v3a5 5 0 0 0 5 5z" /> },
    { name: 'واتس‌اپ', url: 'https://wa.me/19342032497', icon: <path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z" /> },
    { name: 'فیس‌بوک', url: 'https://www.facebook.com/share/18h8Drdg6z/', icon: <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" /> },
  ];

  const tabs = [
    { id: 'information', label: 'اطلاعات شخصی' },
      ...
      <div className="max-w-7xl w-full flex flex-col md:flex-row gap-10 relative z-10">
        ...
        <div className="w-full md:w-80 shrink-0 flex flex-col gap-8">
          ...
          <div className="bg-zinc-900/40 backdrop-blur-xl border border-zinc-800/60 rounded-3xl p-8 flex flex-col items-center text-center shadow-2xl shadow-black hover:shadow-[#D4AF37]/5 hover:-translate-y-1 transition-all duration-500 group">
            ...
            <h1 className="text-3xl font-black text-white tracking-tight mb-2">شاهین <span className="text-[#D4AF37]">صافی</span></h1>
          ...
          <div className="bg-zinc-900/40 backdrop-blur-xl border border-zinc-800/60 rounded-3xl p-4 flex flex-col gap-2 shadow-2xl">
            {tabs.map((tab) => (
              <button
                ...
                className={`w-full text-right px-6 py-4 rounded-2xl font-bold uppercase tracking-wider text-sm transition-all duration-300 flex items-center gap-4 ${
                  activeTab === tab.id 
          ...
          <div className="animate-[fadeIn_0.5s_ease-out]">
            ...
            {activeTab === 'information' && (
              <div className="space-y-12">
                <div>
                  <h2 className="text-4xl font-black text-white mb-6 uppercase tracking-tight">درباره <span className="text-[#D4AF37]">من</span></h2>
                  <p className="text-zinc-400 text-lg leading-relaxed text-justify max-w-3xl">
                    خلاق، پرانرژی و علاقه‌مند به تکنولوژی و کسب‌وکارهای آنلاین. دارای تجربه در تدریس علوم کامپیوتر، مدیریت سیستم‌های IT و بنیان‌گذار مجموعه Safi Group. من پل ارتباطی بین زیرساخت‌های فنی و اکوسیستم‌های دیجیتال مدرن را ایجاد می‌کنم.
                  </p>
                </div>

                <div>
                  <h3 className="text-2xl font-bold text-white mb-6 uppercase tracking-wider border-r-4 border-[#D4AF37] pr-4">شبکه‌های اجتماعی</h3>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {socials.map((social, idx) => (
                      ...
                      >
                        ...
                        <svg className="w-4 h-4 mr-auto text-zinc-600 group-hover:text-[#D4AF37] group-hover:-translate-x-1 transition-all rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"/></svg>
                      </Link>
                    ))}
                  </div>
                </div>
            ...
            {activeTab === 'education' && (
              <div>
                <h2 className="text-4xl font-black text-white mb-10 uppercase tracking-tight">تحصیلات <span className="text-[#D4AF37]">من</span></h2>
                <div className="space-y-6">
                  {education.map((edu, index) => (
                    <div key={index} className="relative overflow-hidden rounded-2xl border border-zinc-800 bg-black p-8 hover:border-[#D4AF37]/30 hover:-translate-y-1 transition-all duration-500 group">
                      <div className="absolute right-0 top-0 bottom-0 w-1 bg-zinc-800 group-hover:bg-[#D4AF37] transition-colors duration-500"></div>
                      ...
                      <div className="inline-block mt-3 px-3 py-1 bg-zinc-900 border border-zinc-800 rounded-lg text-zinc-500 text-sm font-mono" dir="ltr">{edu.duration}</div>
            ...
            {activeTab === 'skills' && (
              <div>
                <h2 className="text-4xl font-black text-white mb-10 uppercase tracking-tight">مهارت‌های <span className="text-[#D4AF37]">فنی</span></h2>
                <div className="space-y-12">
                  {skills.map((skillGroup, index) => (
                    <div key={index}>
                      <h3 className="text-xl font-bold text-white mb-6 uppercase tracking-wider border-r-4 border-[#D4AF37] pr-4">
                        {skillGroup.category}
                      </h3>
                      <div className="flex flex-wrap gap-4">
                        {skillGroup.items.map((skill, i) => (
                          ...
                          >
                            ...
                            <span className="font-semibold text-zinc-300 group-hover:text-white transition-colors" dir="ltr">
                              {skill.name}
                            </span>
                          </div>
                        ))}
            ...
            {activeTab === 'experience' && (
              <div>
                <h2 className="text-4xl font-black text-white mb-10 uppercase tracking-tight">تجربه <span className="text-[#D4AF37]">کاری</span></h2>
                <div className="space-y-6">
                    ...
                    <div key={index} className="relative overflow-hidden rounded-2xl border border-zinc-800 bg-black p-8 hover:border-[#D4AF37]/30 hover:-translate-y-1 transition-all duration-500 group">
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        ...
                        <div className="shrink-0">
                          <span className="inline-block px-4 py-2 bg-zinc-900 border border-zinc-800 rounded-xl text-zinc-500 font-mono text-sm" dir="ltr">{exp.duration}</span>
                        </div>
                      </div>
