...
export default function BlogPage() {
  return (
    <div className="min-h-screen bg-black text-white ltr pt-32 pb-24 px-6 flex flex-col items-center justify-center" dir="ltr">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <p className="text-gray-400 text-xl md:text-2xl max-w-2xl mx-auto leading-relaxed mb-16">
          We are preparing a curated collection of expert articles on Fintech innovation, 
          digital security, and global investment strategies. 
          The first wave of analytical blogs will be published here shortly.
        </p>

        {/* Placeholder Cards - Visual cues for upcoming content */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 opacity-10 grayscale">
          {[1, 2, 3].map((i) => (
            <div key={i} className="h-64 rounded-3xl border border-zinc-800 bg-zinc-900/50 p-6 flex flex-col justify-end text-left">
